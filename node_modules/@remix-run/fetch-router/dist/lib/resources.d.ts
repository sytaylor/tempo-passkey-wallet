 ...
 */
export declare function createResources<base extends string, const options extends ResourcesOptions>(base: base | RoutePattern<base>, options?: options): BuildResourcesMap<base, options>;
