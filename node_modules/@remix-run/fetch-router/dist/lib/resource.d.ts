 ...
 */
export declare function createResource<base extends string, const options extends ResourceOptions>(base: base | RoutePattern<base>, options?: options): BuildResourceMap<base, options>;
